...
<div class="wrap">
    ...
    echo Nav::widget([
        ...
        'items' => [
            ...
            '<li class="link article-switch-languages js-article-switch-languages" title="Swap the original and the translation"><a class="btn"><i class="fa fa-2x fa-arrows-h"></i></a></li>',
        ]
    ]);
